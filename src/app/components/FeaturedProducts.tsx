...
//           <div
//             key={idx}
//             className="bg-light text-center rounded-lg p-4 shadow-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-3xl group w-74"
//           >
...
import Image from "next/image";
import useInView from "@/hooks/useInView"; // Make sure this path matches your structure
